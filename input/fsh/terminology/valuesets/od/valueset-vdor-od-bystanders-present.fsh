ValueSet: VDORBystandersPresentVS
...
* include vdor-custom-code-system#od-bystanders-present-4 "Bystanders present, unknown number"
* include vdor-custom-code-system#od-bystanders-present-5 "Unknown if bystander present"